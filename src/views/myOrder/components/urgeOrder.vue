<template>
  <div class="urge_box">
    <el-dialog :modal="false" title="催件" :visible.sync="dialogVisible" width="500px" center>
      <el-form :model="form" label-width="88px" :rules="rules" ref="form">
...
export default {
  ...
  methods: {
    // 获取上次content
    getLast() {
      if (this.dialogVisible && this.urgeId) {
        netAPI.urgeMessById(this.urgeId).then(res => {
